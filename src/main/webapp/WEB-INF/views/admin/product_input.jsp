	...
	$("#p_dcode").keyup(function(e){
		...
		*/
		if(e.keyCode == KEY_F9){
			...
			let win_style = "toolbar=no, scrollbar=yes, resizable=no, top=300, left=800, width=400, height=400"
...
<div class="form-group">
	...
	<div class="container-fluid form-group row">
		<form:input path="p_iprice" class="form-control" placeholder="매입단가" />
		<form:errors path="p_iprice" class="in-errors" />
		<form:input path="p_oprice" class="form-control" placeholder="판매단가" />
